...
def parse_args():
    ...
    parser.add_argument('--data-path', default=r'./DVSGesture', help='path to dataset')
    ...
    parser.add_argument('--classes', default=11, type=int, help='number of classes')
    parser.add_argument('--img', default=128, type=int, help='size of input image')
    parser.add_argument('--device', default='cuda', help='device')
    parser.add_argument('--dataset', default='DVSGesture', help='choose a dataset')
    parser.add_argument('--dts_cache', default='./dts_cache', help='cache path')
    parser.add_argument('--model', default='PLIF_spikeformer_7_5x3x1', help='model variant')
    ...
    parser.add_argument('--ls', type=float, help='label smoothing', default=0)
    parser.add_argument('--momentum', default=0.9, type=float, metavar='M',
                        help='Momentum for SGD. Adam will not use momentum')
    parser.add_argument('--wd', '--weight-decay', default=0.00015, type=float,
                        metavar='W', help='weight decay (default: 0.00015)',
                        dest='weight_decay')
