...
def main(args):
    ...
    if args.warmup > -1:
        ...
        warmup_lr_scheduler = torch.optim.lr_scheduler.LinearLR(
            optimizer, start_factor=args.lr_warmup_decay, total_iters=args.warmup
        )

        lr_scheduler = torch.optim.lr_scheduler.SequentialLR(
            optimizer, schedulers=[warmup_lr_scheduler, lr_scheduler], milestones=[args.warmup]
        )
...
def parse_args():
    ...
    parser.add_argument('--data-path', default=r'./ImageNet', help='path to dataset')
    ...
    parser.add_argument('--classes', default=1000, type=int, help='number of classes')
    parser.add_argument('--img', default=224, type=int, help='size of input image')
    parser.add_argument('--device', default='cuda', help='device')
    parser.add_argument('--dataset', default='ImageNet', help='choose a dataset')
    parser.add_argument('--dts_cache', default='./dts_cache', help='cache path')
    parser.add_argument('--model', default='PLIAF_spikeformer_7_3x2x4', help='model variant')
    parser.add_argument('-b', '--batch-size', default=20, type=int, help='training batch size')
    ...
    parser.add_argument('-j', '--workers', default=14, type=int, metavar='N',
                        help='number of data loading workers (default: 14)')
    parser.add_argument('--lr', type=float, help='initial learning rate', default=0.01)
    parser.add_argument('--ls', type=float, help='label smoothing', default=0.1)
    ...
    parser.add_argument('--dvsaug', action='store_true', help='Use DVS Data Augumentation')
